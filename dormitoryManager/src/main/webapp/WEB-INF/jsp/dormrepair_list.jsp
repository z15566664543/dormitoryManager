            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_id" class="layui-input" maxlength="3" placeholder="请输入宿舍编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="r_name" maxlength="10" class="layui-input" placeholder="请输入维修人员">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="reason" class="layui-input" maxlength="25" placeholder="请输入报修事由">
                    </div>
                </div>

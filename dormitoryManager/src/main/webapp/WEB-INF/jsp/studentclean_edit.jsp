...
<div class="x-body">
    <form class="layui-form"  id="f_auto" action="updateStudentClean" method="post" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="s_studentid" name="s_studentid"
                       autocomplete="off" maxlength="10" value="${sessionScope.d.s_studentid}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="s_name" maxlength="10" name="s_name"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="s_grade" maxlength="3" name="s_grade"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="s_classid" maxlength="3" name="s_classid"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="s_dormitoryid" maxlength="3" name="s_dormitoryid"

            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="s_studentid" maxlength="10"  class="layui-input" placeholder="请输入学号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="s_name" maxlength="10" class="layui-input" placeholder="请输入姓名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_age" maxlength="2" class="layui-input" placeholder="请输入年龄">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  name="s_phone" maxlength="11" class="layui-input" placeholder="请输入电话">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_classid" maxlength="3" class="layui-input" placeholder="请输入班级编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_classname" maxlength="10" class="layui-input" placeholder="请输入班级名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_dormitoryid" maxlength="3" class="layui-input" placeholder="请输入寝室编号">
                    </div>
                </div>
        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addUpdatForm" >
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">学号：</label>
                    <div class="layui-input-block">
                        <input type="text"  name="s_studentid"  maxlength="10" id="edit_studentid"  value=""  class="layui-input" placeholder="请输入学号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">姓名：</label>
                    <div class="layui-input-block">
                        <input type="text"  name="s_name" id="edit_names"  maxlength="10" value="" class="layui-input" placeholder="请输入姓名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">年龄：</label>
                    <div class="layui-input-block">
                        <input type="text" name="s_age" class="layui-input"  maxlength="2" id="edit_age" value="" placeholder="请输入年龄">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">电话：</label>
                    <div class="layui-input-block">
                        <input type="text"  name="s_phone" id="edit_phone"  maxlength="11" value="" class="layui-input" placeholder="请输入电话">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">班级编号：</label>
                    <div class="layui-input-block">
                        <input type="text" name="s_classid" id="edit_classids" maxlength="3" value="" class="layui-input" placeholder="请输入班级编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">班级名：</label>
                    <div class="layui-input-block">
                        <input type="text" name="s_classname" id="edit_classname" maxlength="10" value="" class="layui-input" placeholder="请输入班级名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_dormitoryid" maxlength="3" id="edit_dormitoryids" value="" class="layui-input" placeholder="请输入宿舍编号">
                    </div>
                </div>

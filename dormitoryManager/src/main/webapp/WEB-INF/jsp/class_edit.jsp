        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="c_classid" name="c_classid"
                       autocomplete="off" value="${sessionScope.c.c_classid}"  maxlength="3" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="c_classname" name="c_classname"
                       autocomplete="off" value="${sessionScope.c.c_classname}"  maxlength="10" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="c_counsellor" name="c_counsellor"
                       autocomplete="off" value="${sessionScope.c.c_counsellor}"  maxlength="10" class="layui-input">
            </div>
        </div>

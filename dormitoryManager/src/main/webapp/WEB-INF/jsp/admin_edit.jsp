        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="a_username" name="a_username"
                       autocomplete="off" value="${sessionScope.a.a_username}" maxlength="10" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="a_password" name="a_password"
                       autocomplete="off" value="${sessionScope.a.a_password}" maxlength="6" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="a_name" name="a_name"
                       autocomplete="off" value="${sessionScope.a.a_name}" maxlength="10" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="a_phone" name="a_phone"
                       autocomplete="off" value="${sessionScope.a.a_phone}" maxlength="11" pattern="(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="a_power" name="a_power"
                       autocomplete="off" value="${sessionScope.a.a_power}" maxlength="1" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="a_describe" name="a_describe"
                       autocomplete="off" value="${sessionScope.a.a_describe}" maxlength="25" class="layui-input">
            </div>
        </div>

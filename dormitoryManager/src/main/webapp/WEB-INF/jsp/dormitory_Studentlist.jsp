        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_bed" maxlength="9" class="layui-input" placeholder="请输入已用床位">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="a_name" maxlength="10" class="layui-input" placeholder="请输入管理员姓名">
                    </div>
                </div>

            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="a_username" class="layui-input"  maxlength="10" placeholder="请输入用户名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    	<input type="password" lay-verify="required" name="a_password" maxlength="6" class="layui-input" placeholder="请输入密码">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="a_name" class="layui-input" maxlength="10" placeholder="请输入姓名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="a_phone" class="layui-input" maxlength="11" pattern="(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$" placeholder="请输入电话">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="a_power" maxlength="1" class="layui-input" placeholder="请输入级别1-2">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="a_describe" class="layui-input" maxlength="25" placeholder="请输入级别描述">
                    </div>
                </div>

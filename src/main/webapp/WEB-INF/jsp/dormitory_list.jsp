            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_dormitoryid" maxlength="3" class="layui-input" placeholder="请输入宿舍编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_dormbuilding" maxlength="5" class="layui-input" placeholder="请输入宿舍楼">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_bedtotal" maxlength="9" class="layui-input" placeholder="请输入床位总数">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_bed" class="layui-input" maxlength="9" placeholder="请输入已用床位">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="a_name" class="layui-input" maxlength="10" placeholder="请输入管理员姓名">
                    </div>
                </div>

            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="c_classid"  maxlength="3" class="layui-input" placeholder="请输入班级编号">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required"  maxlength="10" name="c_classname"  class="layui-input" placeholder="请输入班级名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="c_counsellor"  maxlength="10" class="layui-input" placeholder="请输入辅导员姓名">
                    </div>
                </div>

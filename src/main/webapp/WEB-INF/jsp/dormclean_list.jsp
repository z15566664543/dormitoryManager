        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_dormbuilding" class="layui-input"  maxlength="5" placeholder="请输入宿舍楼">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="d_grade" class="layui-input"  maxlength="3" placeholder="请输入卫生打分">
                    </div>
                </div>
